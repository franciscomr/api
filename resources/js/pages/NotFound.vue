...
<template>
  <div class="w-full backdrop-blur-sm bg-blue-100/90 h-full shadow-xl rounded-lg flex overflow-x-auto custom-scrollbar">
    <div class="w-64 px-4">
      ...
      <div class="px-2 pt-4 pb-8 border-r border-gray-300">
        <ul class="space-y-2">
          ...
          <li>
            <a
              class="hover:bg-gray-500 hover:bg-opacity-10 hover:text-blue-500 flex items-center justify-between text-gray-700 py-1.5 px-4 rounded space-x-2 cursor-pointer">
              <span class="flex items-center space-x-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                  stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
  ...
  <div class="backdrop-blur-sm bg-blue-100/90 rounded-xl flex h-full">
    ...
    <div class="flex items-center justify-center p-4 w-full">
      <h1 class="text-lg font-medium text-black">404 | Not Found</h1>
    </div>
  </div>
